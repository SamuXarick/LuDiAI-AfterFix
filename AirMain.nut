...
//							if (!AIController.GetSetting("randomize_towns") && !this.air_route_manager.m_routes_built.all[cargo_class] && this.air_route_manager.HasMaxStationCount(city_from, city_to, cargo_class)) {
